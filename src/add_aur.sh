#!/usr/bin/env bash
# Modified from: https://github.com/greyltc/docker-archlinux-aur/blob/master/add-aur.sh
# Sets up unattended aur access via yay for a user given as the first argument
set -o pipefail -e
